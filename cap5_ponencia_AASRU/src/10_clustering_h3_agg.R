...
exp_2_h3 <- read_csv('./cap5/data/proc/estab_to_h3.csv')
...
pca_data <- bake(pca_estimates, exp_clst)
...
ti# Hierarchical clustering using Complete Linkage
...
write_csv(exp_clst, './cap5/data/proc/estab_to_h3_pca_clust.csv')
